...
<head>
    ...
    <title>Cadastro - Sabor & Cia</title>
    ...
    <main class="flex-1 container mx-auto px-4 py-8 flex items-center justify-center min-h-[calc(100vh-80px)]">
        <div class="w-full max-w-md bg-card border border-border rounded-lg p-8 space-y-6">
            <div class="text-center space-y-2">
                <h2 class="text-3xl font-bold text-foreground">Criar conta</h2>
                <p class="text-muted-foreground">Cadastre-se para fazer pedidos</p>
            </div>
            ...
            <form action="{{ route('register.store') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            value="{{ old('name') }}"
                            class="w-full h-12 pl-10 pr-4 bg-background border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-ring @error('name') border-destructive @enderror"
                            required
                        />
                    </div>
                    @error('name')
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            value="{{ old('phone') }}"
                            class="w-full h-12 pl-10 pr-4 bg-background border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-ring @error('phone') border-destructive @enderror"
                            required
                        />
                    </div>
                    @error('phone')
                ...
                <div class="space-y-2">
                    <label for="password_confirmation" class="text-sm font-medium text-foreground">Confirmar senha</label>
                    <div class="relative">
                        <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <rect width="18" height="11" x="3" y="11" rx="2" ry="2"/>
                            <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
            ...
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="bg-card px-4 text-muted-foreground">Ou cadastre-se com</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <a href="{{ route('auth.facebook') }}" class="flex items-center justify-center gap-2 h-12 px-4 border border-border hover:bg-muted rounded-lg transition-colors">
